...
![img](./assets/wps1-1747654898598-1.jpg) 

试了一会儿找到了隐写

![img](./assets/wps2-1747654898598-2.jpg) 

的确是类似的变换

![img](./assets/wps3-1747654898599-3.jpg) 

找了个脚本还原，如图

![img](./assets/wps4-1747654898599-4.jpg) 

类似二维码，但又不是，但是图片大小也是`400*400`，或许可以考虑做异或，先反色处理并转正

![img](./assets/wps5-1747654898599-5.jpg) 

和一开始的jpg做异或

![img](./assets/wps6-1747654898599-6.jpg) 

的确出现了一个新的二维码

![img](./assets/wps7-1747654898599-7.jpg) 

扫描得到flag

![img](./assets/wps8-1747654898599-8.jpg) 
...
![img](./assets/wps1-1747654947888-17.jpg) 

发现在`[Content_Types].xml`后面有个注释，先记住。

![img](./assets/wps2-1747654947888-18.jpg) 

网盘的文件终于下好了，一看是个`vmem`，用vol2分析。

![img](./assets/wps3-1747654947888-19.jpg) 

`Cmdscan`发现有个`hahaha.zip`，比较可疑。`Filedump`出来分析。

但是发现是加密的

![img](./assets/wps4-1747654947888-20.jpg) 
...
![img](./assets/wps5-1747654947888-21.jpg) 
...
![img](./assets/wps1-1747655381001-28.jpg) 

有很多佛曰加密

![img](./assets/wps2-1747655381001-29.jpg) 

挨个解开看看

![img](./assets/wps3-1747655381001-30.jpg) 

继续看源码

![img](./assets/wps4-1747655381001-31.jpg) 

有个display的组件，展示出来，多了一个输入框，还有一个路由，但目前无法访问

![img](./assets/wps5-1747655381001-32.jpg) 

![img](./assets/wps6-1747655381002-33.jpg) 

但是提交说我错误

![img](./assets/wps7-1747655381002-34.jpg) 

回头看源码，发现参数很奇怪，`aGnsEweTr6`，是在answer6中间塞了个GET，推测最后一个答案要用get传，bp打开

![img](./assets/wps8-1747655381002-35.jpg) 

拿到一个通关的session，现在拿着这个session去访问之前F12看到的路由

![img](./assets/wps9-1747655381003-36.jpg) 
...
![img](./assets/wps10-1747655381003-37.jpg) 

![img](./assets/wps11-1747655381003-38.jpg) 

无回显的`SSTI`，那推测之前的字符串应该是存放flag的文件

好像没啥过滤，很轻松就能打通

![img](./assets/wps12-1747655381003-39.jpg) 
...
![img](./assets/wps25-1747655439462-53.jpg) 

发现`role`是`user`，改成`admin`试试，用Jerry_Loves_Cheese加密

 

![img](./assets/wps26-1747655439462-52.jpg) 

修改session

![img](./assets/wps27-1747655439462-54.jpg) 

刷新一下

![img](./assets/wps28-1747655439462-55.jpg) 

访问

![img](./assets/wps29-1747655439462-56.jpg) 

和之前说的`22`的十六进制做异或

![img](./assets/wps30-1747655439462-57.jpg) 
